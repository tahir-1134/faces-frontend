...
//         <p>
//           <div className="dtext-head"><h1>Disclaimer</h1></div>
//         </p>
//         <p>
...
//           </li>
//           <li>
//             For <strong>confirming</strong> your slot in the event, you need to go to the
//             Council's desk, <strong>check out from the checkout page, and complete the
//             Cash payment</strong> to get the receipt. Until then, your slot is unconfirmed
